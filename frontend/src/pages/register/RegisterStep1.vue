...
<div class="container_register">
  ...
  <div class="content">
    <form id="register_form" class="form btn_fixed">
      <div class="form_content">
        <div class="form_section">
          <div class="check_terms">
            <input type="checkbox" id="chk_all" class="chk_all_btn"/>
              ...
              <div class="check_wrap">
                ...
                <label for="termsService">
                  ...
                  <div class="text_wrap">
                    ...
                    <a href="https://policy.naver.com/policy/service.html" class="link_arrow">전체</a>
                  </div>
                </label>
              </div>
            </div>
